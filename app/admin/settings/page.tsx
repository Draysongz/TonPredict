    ...
    <div className="bg-background-dark text-slate-900 min-h-screen overflow-x-hidden gradient-bg">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
              <span className="material-icons-round text-white text-lg">settings</span>
            </div>
            <div>
      ...
      <main className="px-5 pt-24 pb-32">
        ...
        <div className="space-y-3">
          <Link
            href="/admin/factory"
            className="glass rounded-2xl p-4 flex items-center gap-4 border border-slate-200 hover:border-primary/30 transition-colors group"
          >
            <div className="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center group-hover:bg-primary/30 transition-colors">
              <span className="material-icons-round text-primary text-2xl">precision_manufacturing</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="font-bold text-slate-900">Factory Contract Overview</p>
        ...
        <div className="space-y-3">
          <div className="glass rounded-2xl p-4 flex items-center gap-4 border border-slate-200">
