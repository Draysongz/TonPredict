    ...
    <div className="bg-background-dark text-white min-h-screen pb-24">
      ...
      <main className="px-5 space-y-6 pt-20">
            ...
            <svg className="w-full h-full" viewBox="0 0 400 100" preserveAspectRatio="none">
              <defs>
                <linearGradient id="chartGrad" x1="0%" x2="0%" y1="0%" y2="100%">
                  <stop offset="0%" style={{ stopColor: "#C3FF4D", stopOpacity: 1 }}></stop>
                  <stop offset="100%" style={{ stopColor: "#C3FF4D", stopOpacity: 0 }}></stop>
                </linearGradient>
              </defs>
              <path
              ...
              <path
                ...
                opacity="0.2"
              ></path>
              <circle cx="400" cy="10" fill="#C3FF4D" r="4"></circle>
            </svg>
          </div>
        ...
        <section className="grid grid-cols-2 gap-4">
          <button className="group relative overflow-hidden glassmorphic rounded-2xl p-4 transition-all active:scale-95 border border-primary/20">
            <div className="relative z-10 flex flex-col items-center gap-1">
              ...
              <span className="text-xl font-bold text-white">$0.64</span>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="glassmorphic rounded-2xl divide-y divide-white/5">
            <div className="p-4 flex justify-between items-center">
              ...
              <span className="text-sm font-semibold text-white">Oct 31, 2024</span>
            </div>
            <div className="p-4 flex justify-between items-center">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-surface-dark flex items-center justify-center">
                ...
                <span className="text-sm font-medium text-slate-200">Source of Truth</span>
              </div>
            ...
            <div className="p-4 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-slate-200">Market Rules</span>
              </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between glassmorphic p-3 rounded-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold text-white">TON_Whale.ton</div>
              ...
              <div className="text-right">
                <div className="text-sm font-bold text-white">5,000 TON</div>
            ...
            <div className="flex items-center justify-between glassmorphic p-3 rounded-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold text-white">Anonymous User</div>
                  <div className="text-[10px] text-slate-500">
                    Bought <span className="text-white font-bold">NO</span> • 15m ago
                  </div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-sm font-bold text-white">1,200 TON</div>
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-md z-50">
        <div className="bg-primary text-background-dark p-4 rounded-full flex items-center justify-between shadow-2xl shadow-primary/20">
          <div className="pl-4">
          ...
          <button className="bg-background-dark text-primary font-black px-6 py-2.5 rounded-full text-sm uppercase tracking-widest active:scale-95 transition-transform">
            Trade Now
          </button>
        </div>
      </div>
